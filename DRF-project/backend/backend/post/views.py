...
class FaceResultView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            known_image_path = "/home/sanchit/San/biaszero/new/DRF-project/backend/backend/file/images/Sanchit_Gupta.jpg"
            predictor_path = '/home/sanchit/San/biaszero/new/DRF-project/backend/backend/post/shape_predictor_68_face_landmarks.dat'  
