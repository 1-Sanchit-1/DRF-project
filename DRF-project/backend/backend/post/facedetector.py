...
class FaceRecognizer:
    ...
    def __init__(self, known_image_path="post/known_person.jpg", predictor_path="/home/sanchit/San/biaszero/new/DRF-project/backend/backend/post/shape_predictor_68_face_landmarks.dat"):
        """
